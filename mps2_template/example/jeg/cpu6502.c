...
uint_fast16_t address_mode_ADR_ABSOLUTE(cpu6502_t *cpu, uint_fast16_t address) 
{
    address=READ16(cpu->reg_PC+1);
}

/*
uint_fast16_t address_mode_ADR_ABSOLUTE_X(cpu6502_t *cpu, uint_fast16_t address) 
{
