...
/* Interrupts */
void NONSEC_WATCHDOG_RESET_IRQHandler (void) __attribute__ ((weak, alias("Default_Handler")));
void NONSEC_WATCHDOG_IRQHandler       (void) __attribute__ ((weak, alias("Default_Handler")));
...
void BRIDGE_ERROR_IRQHandler          (void) __attribute__ ((weak, alias("Default_Handler")));

void FPIDC_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void FPDZC_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void FPOFC_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void FPUFC_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void FPIXC_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
...
void UART2RX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART2TX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART3RX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART3TX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART4RX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART4TX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART0_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void UART1_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void UART2_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void UART3_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void UART4_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void UARTOVF_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
...
void GPIO0_0_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_1_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_2_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_3_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_4_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_5_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_6_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_7_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_8_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_9_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_10_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_11_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_12_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_13_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_14_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO0_15_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_0_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_1_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_2_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_3_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_4_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_5_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_6_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_7_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_8_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_9_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_10_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_11_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_12_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_13_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_14_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO1_15_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_0_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_1_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_2_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_3_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_4_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_5_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_6_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_7_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_8_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_9_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_10_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_11_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_12_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_13_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_14_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO2_15_IRQHandler              (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO3_0_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO3_1_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO3_2_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void GPIO3_3_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART5RX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART5TX_IRQHandler               (void) __attribute__ ((weak, alias("Default_Handler")));
void UART5_IRQHandler                 (void) __attribute__ ((weak, alias("Default_Handler")));
void HDCLCD_IRQHandler                (void) __attribute__ ((weak, alias("Default_Handler")));
...
extern const pFunc __VECTOR_TABLE[496];
  ...
  0,                                        /*   2: Reserved */
  TIMER0_IRQHandler,                        /*   3: TIMER 0 Interrupt */
  TIMER1_IRQHandler,                        /*   4: TIMER 1 Interrupt */
  ...
  UART0RX_IRQHandler,                       /*  32: UART 0 Receive Interrupt */
  UART0TX_IRQHandler,                       /*  33: UART 0 Transmit Interrupt */
  ...
  I2S0_IRQHandler,                          /*  49: FPGA Audio I2S Interrupt */
  TSC_IRQHandler,                           /*  50: Touch Screen Interrupt */
  USB_IRQHandler,                           /*  51: USB Interrupt */
  SPI0_IRQHandler,                          /*  52: SPI ADC Interrupt */
  SPI1_IRQHandler,                          /*  53: SPI (Shield 0) Interrupt */
  SPI2_IRQHandler,                          /*  54: SPI (Shield 1) Interrupt */
  0,                                        /*  55: Reserved */
  0,                                        /*  56: Reserved */
  0,                                        /*  57: Reserved */
  0,                                        /*  58: Reserved */
 ...
 *----------------------------------------------------------------------------*/
void __NO_RETURN SecureFault_Handler(void)
{
  while(1);
}
